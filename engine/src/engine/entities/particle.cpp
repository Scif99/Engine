...
void engine::particle::on_update(const engine::timestep& timestep)
{
...
bool engine::particle::initialise(glm::vec3 p, float width, float height, glm::vec3 start_colour, glm::vec3 end_colour, float transition_speed)
{
	...
	m_velocity = glm::vec3(r1 * 0.1f, 0.0f, r2 * 0.1f);
...
glm::mat4 engine::particle::on_render(glm::vec3 look_at, glm::vec3 up_vector, engine::ref<engine::shader> shader)
{
